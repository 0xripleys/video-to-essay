        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- SKIP images that are not relevant to the essay content (e.g. end-of-video promo cards, "
                    "subscription prompts, links to other content, QR codes, or slides about unrelated topics). "
                    "Simply omit irrelevant images from the placements array.\n"
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "- Only reference a figure if there is a genuinely relevant sentence nearby. "
                        "If an image does not relate to the surrounding text (e.g. a promo slide placed "
                        "at the end), do NOT force a reference — omit it from the array.\n"
